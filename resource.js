...
/* JavaScript: unobtrusive form validation + redirect on success */
(function () {
  ...
  form.addEventListener('submit', function (e) {
    ...
    // Use built-in HTML5 validity check for type="email" + required
    if (!emailInput.checkValidity()) {
      // You requested this exact message
      showError('plz fill the details.');
      return;
    }

    // If valid — go to 404.html (as you wanted)
    // If you later want to actually submit to a server, replace this redirect with form.submit()
